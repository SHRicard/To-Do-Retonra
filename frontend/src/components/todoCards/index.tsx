...
export const TodoCards: React.FC<TodoCardsProps> = ({ toggleTheme, isDarkMode }) => {
    ...
    return (
        <CRow >
            <CCol md={12}>
                <CCol md={12} className="d-flex justify-content-between align-items-center py-4">
                    <CCol md={6}>
                        <span
                            style={{
                    ...
                    <CCol md={6} className="text-end" onClick={toggleTheme} style={{ cursor: 'pointer' }}>
                        <span
                            style={{
                                fontSize: theme.typography.fontSize,
                                color: theme.palette.background.default,
